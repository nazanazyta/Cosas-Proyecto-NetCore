...
INSERT INTO RESERVAS (ID, IDUSU, IDPER, FECHA, TURNO)
	VALUES (1, 3, 1, CONVERT(DATETIME, '01/28/2021 09:00:00'), 'mañana');
INSERT INTO RESERVAS (ID, IDUSU, IDPER, FECHA, TURNO)
	VALUES (2, 2, 2, CONVERT(DATETIME, '01/28/2021 09:00:00'), 'mañana');
INSERT INTO RESERVAS (ID, IDUSU, IDPER, FECHA, TURNO)
	VALUES (3, 3, 1, CONVERT(DATETIME, '01/28/2021 15:00:00'), 'tarde');
INSERT INTO RESERVAS (ID, IDUSU, IDPER, FECHA, TURNO)
	VALUES (4, 3, 3, CONVERT(DATETIME, '01/30/2021 09:00:00'), 'mañana');
INSERT INTO RESERVAS (ID, IDUSU, IDPER, FECHA, TURNO)
	VALUES (5, 2, 2, CONVERT(DATETIME, '01/29/2021 15:00:00'), 'tarde');
INSERT INTO RESERVAS (ID, IDUSU, IDPER, FECHA, TURNO)
	VALUES (6, 3, 3, CONVERT(DATETIME, '01/30/2021 15:00:00'), 'tarde');
...
insert into usuarios values (1, 'naza', 'naza', 'naza')
select * from usuarios
